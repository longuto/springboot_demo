...
public class FileUtil {
     ...
     * @return ResponseBo
     */
    public static APIResponse createExcelByPOIKit(String filename, List<?> list, Class<?> clazz) {

        if (list.isEmpty()) {
            return APIResponse.fail("导出数据为空！");
        } else {
            ...
            if (operateSign) {
                ...
                return APIResponse.fail("导出Excel失败，请联系网站管理员！");
            }
        }
    }
     ...
     * @return ResponseBo
     */
    public static APIResponse createCsv(String filename, List<?> list, Class<?> clazz) {
        ...
        if (list.isEmpty()) {
            ...
            if (operateSign) {
                ...
                return APIResponse.fail("导出Csv失败，请联系网站管理员！");
            }
        }
    }
